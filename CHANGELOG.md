...
* Replaced attribute "vcenter_fqdn" and "vcenter_id from the "vcf_domain" datasource with "vcenter" subresource, that contains "id" and "fqdn" attributes. 
