# Contributing to terraform-provider-vcf

Before you start working with terraform-provider-vcf please read our Developer Certificate
...
``` shell
git remote add upstream https://github.com/vmware/terraform-provider-vcf.git
